...
@Component({
    ...
    standalone: true,
    imports: [MatIconModule, MatButtonModule, NgIf, MatFormFieldModule, MatInputModule, FormsModule, MatAutocompleteModule, NgFor, MatOptionModule, MatChipsModule, TableComponent, DatePipe]
})
